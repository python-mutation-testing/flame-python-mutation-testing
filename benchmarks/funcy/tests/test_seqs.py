...
def test_keep():
    assert lkeep(lambda x: x % 3, range(5)) == [1, 2, 1]
...
def test_split():
    assert lmap(list, split(lambda x: x % 2, range(5))) == [[1, 3], [0, 2, 4]]

def test_lsplit():
    assert lsplit(lambda x: x % 2, range(5)) == ([1, 3], [0, 2, 4])
...
def test_split_by():
    assert lsplit_by(lambda x: x % 2, [1, 2, 3]) == ([1], [2, 3])

def test_group_by():
    assert group_by(lambda x: x % 2, range(5)) == {0: [0, 2, 4], 1: [1, 3]}
